...
You are looking at the legacy version of tado API proxy. It is recommended to switch to the [new version](https://github.com/s1adem4n/tado-api-proxy)!
...
docker run -d \
  ...
  ghcr.io/s1adem4n/tado-api-proxy:legacy
```
...
Download the latest v0.x.x release from the [releases page](https://github.com/s1adem4n/tado-api-proxy/releases).
...
| ----------------- | --------------------------------------------- | -------------------------------------- | -------- |
| EMAIL | tado account email | _none_ | Yes |
| PASSWORD | tado account password | _none_ | Yes |
